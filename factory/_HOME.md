---
type: moc
title: JIVO Factory (Jivamart) — Home
tags:
  - moc
  - source/factory
---

# JIVO Factory — Jivamart (JIVO_MART)
...
- **Notes:** 47469  ·  **Entity types:** 37  ·  **SAP-bridged item codes:** 209
...
- [[_moc-barcode__items__oitm|SAP Item (OITM)]] (200)
...
- [[_moc-gate-core__sales-dispatch__documents|Documents]] (200)
...
## Empty for Jivamart (not configured on the retail arm)
...
- `/production-execution/sap/items/`
...
- `/quality-control/sap-items/`
- `/warehouse/bom-requests/`
- `/warehouse/fg-receipts/`

## SAP product bridge

209 distinct SAP item codes (FG####) are referenced by factory records and link to jivo-data-bank product nodes. See `_bridge.json`.
