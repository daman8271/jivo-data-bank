...
- [[Platform - citymall]] — 0 products
- [[Platform - zomato]] — 0 products
...
- [[WG ROSE 200ML]]
- [[YELLOW MUSTARD 1L]]
- [[YELLOW MUSTARD 1L + 1L]]
- [[YELLOW MUSTARD 5L]]

## Gaps / Unmatched
JIVO SKUs the bridge could **not** map to an ecom listing (9 total) — no product node is minted for these, so they are surfaced here (not silently dropped). Source: `bridge_result.json`.

**No ecom match (8):**
- [[sku-FG0000190|BLACK OLIVES 3KG]]
- [[sku-FG0000048|CANOLA 100ML]]
- [[sku-FG0000158|COTTON SEED OIL]]
- [[sku-FG0000247|LEMON JUICE]]
- [[sku-FG0000026|MUSTARD 15L]]
- [[sku-FG0000248|ORANGE JUICE]]
- [[sku-FG0000191|SOYABEAN 15L]]
- [[sku-FG0000292|SUNFLOWER 15L]]

**Needs review (1):**
- [[sku-FG0000246|COLA JUICE]] — _medium confidence_: Only cola-flavoured juice in list: 'JIVO Healthy Wheatgrass ... Juice (Cola, 250 ml (Pack of 6)

## Vault notes
- [[SESSION-MEMORY]] — JIVO vault session / handoff memory

## Factory pillar — Jivo Mart (JIVO_MART)
The 4th data pillar: a lossless capture of the `ji.jivo.in` factory app for **Jivo Mart** — gate, vehicles, quality control, GRPO, barcode traceability, dispatch, and SAP item master (49,462 notes). Bridged to products above by SAP item code (FG####) — see each product's **Factory lens**.
